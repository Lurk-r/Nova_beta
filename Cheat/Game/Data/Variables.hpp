...
namespace Variables
{
	...
	// Account
	inline std::string LotteryNumber = "204";
	...
	inline bool SetPayingUser = false;
	inline bool SetKeys = false;
	inline bool SpendCurrency = false;
	inline bool AddConsumable = false;
	inline bool LoadoutFixer = false;
	...
	// Spoofing and Progress Shit
	inline std::string GrabbedPlayerProgress = "";

	inline int GrabbedPlayerID = 0;

	inline bool GetPlayerProgress = false; 

	// Pixel Pass and Gifting
	inline std::vector<std::string> currentGiftItems;

	inline int PassDayCount = 50;
	inline int MaxTierNumber = 69696969;

	inline bool CustomBattlepassSender = false;
	inline bool GiftingPassSender = false;

	//Sandbox
	inline int SandboxHeartCount = 69;
	inline int SandboxWingsCount = 69;
	inline int SandboxDiscoCount = 69;
	inline int SandboxHeadCount = 69;
	inline int SandboxBearCount = 69;

	inline bool SetSandboxHeart = false;
	inline bool SetSandboxWings = false;
	inline bool SetSandboxDisco = false;
	inline bool SetSandboxHead = false;
	inline bool SetSandboxBear = false;
}
