...
namespace Socket
{
    ...
    // SignaturePattern: {"private", "Void", nullptr, {"Dictionary`2"}};
	// Index: 0x74 Offset: 0xaa9000 VA: 0x7ff8d13d9000
    //private Void 丙丗丕丝万与丞丌丟(Dictionary<String, Object> 丏业丝丌丘不丞下上) {}
